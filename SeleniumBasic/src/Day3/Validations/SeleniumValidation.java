...
public class SeleniumValidation {
	...
	public static void main(String[] args) {
		...
		System.out.println("Check Box Buttin us displayed or not? "+checkBoxButton.isDisplayed());
		System.out.println("Check Box Button is functional or not ? "+checkBoxButton.isEnabled());
		String CheckBoxTextName= checkBoxButton.getText();
...
//	private static String passwordInputField() {
